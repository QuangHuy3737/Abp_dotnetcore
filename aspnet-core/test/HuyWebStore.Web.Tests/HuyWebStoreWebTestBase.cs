...
{
    public abstract class HuyWebStoreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HuyWebStoreWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HuyWebStoreWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HuyWebStoreDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HuyWebStoreDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HuyWebStoreDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HuyWebStoreDbContext, Task<T>> func)
        {
            T result;
